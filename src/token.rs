...
#[derive(Debug)]
pub enum ExprRole {
    Number, String, Grouping, Bool, Float, 
    Binary, None, Unary, Expr, Object, 
}
...
impl Token {
    pub fn get_data(&self) -> TokenData {
        ...
        let data = match self {
            ...
            Str(_) => (Lvl::Factor, Role::String, Role::None),
            Float(_) | Number(_) => (Lvl::Factor, Role::Number, Role::None),
            ...
            EqualsEquals | NotEqual => 
                (Lvl::Comparison, ExprRole::None, ExprRole::Expr),
